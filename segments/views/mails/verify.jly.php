	...
	<tr>
		<td class="pad">
			<div style="color:#000000;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:15px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:18px;">
				...
				<p style="margin: 0;">Please click below link to verify.</p>
			</div>
		</td>
	</tr>
</table>
	...
	<tr>
		<td class="pad">
			<div class="alignment" align="center">
				...
				<a href="{{ route('auth.verify',[encrypt($user->id)]) }}" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#3c9986;border-radius:4px;width:auto;border-top:1px solid #3c9986;font-weight:400;border-right:1px solid #3c9986;border-bottom:1px solid #3c9986;border-left:1px solid #3c9986;padding-top:5px;padding-bottom:5px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"><span style="padding-left:20px;padding-right:20px;font-size:14px;display:inline-block;letter-spacing:normal;"><span dir="ltr" style="word-break: break-word; line-height: 28px;"><strong>Verify</strong></span></span></a>
