...
<div class="row">
  <div class="col-md-12">
    <div class="card card-inverse-light-with-black-text flatten-border">
      ...
      <div class="card-body">
      <form method="post" action="{{ route('admin.blogs.update', ['blog' => $blog->id]) }}" id="create-blog-form" enctype="multipart/form-data">
        {{ prevent_csrf() }}
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="description" placeholder="Content">{{ $blog->description }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <br>
                    <img src="{{ url($blog->post_img) }}" style="max-height:100%;max-width:100%;">
                </div>
            </div>
        </div>
